    ...
    <footer className="relative mt-24 bg-primary/5 text-text-main">
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 grid gap-12 md:grid-cols-4">
        ...
        <div>
          <Link
            href="/"
            className="inline-flex items-center gap-1 text-2xl font-extrabold text-primary"
          >
            <Image
          ...
          <p className="mt-4 text-sm leading-relaxed text-text-main/80">
            ...
            veterinário moderno, acolhedor e baseado em evidências para que cada
            pet viva mais e melhor.
          </p>
          ...
          <div className="mt-6 flex gap-4">
            ...
            >
              <svg
                className="h-5 w-5 text-primary hover:text-accent transition"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm text-text-main/80">
            <li>
              <strong>Telefone:</strong> (81) 9 8971-4251
            </li>
            <li>
              <strong>WhatsApp:</strong> (81) 9 8971-4251
            </li>
            <li>
              <strong>E-mail:</strong> pedro.passos081@gmail.com
            </li>
            <li>
              <strong>Endereço:</strong>
              <br /> Rua Exemplo, 123 — Recife/PE
            </li>
            <li>
              <strong>Horário:</strong>
              <br /> Seg–Sex 8h–18h | Sáb 8h–12h
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className="mt-3 text-sm text-text-main/80">
            Fique por dentro de campanhas, dicas de cuidado e eventos da VET
            Dev.
          </p>
      ...
      <div className="border-t border-black/10 bg-white/50 backdrop-blur py-4 text-center text-xs text-text-main/60">
        © {new Date().getFullYear()} VET Dev Todos os direitos reservados. |
        Desenvolvido com ❤️ por{" "}
        <span className="text-primary font-medium">Pedro Passos</span>
      </div>
    </footer>
  );
}
